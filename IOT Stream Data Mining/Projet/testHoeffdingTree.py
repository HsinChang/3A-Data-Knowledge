...
class HoeffdingTTree(BaseSKMObject, ClassifierMixin):
    ...
    class Node(metaclass=ABCMeta):
        ...
        def filter_instance_to_leaf(self, X, parent, parent_branch):
            ...
            X: numpy.ndarray of shape (n_samples, n_features)
               Data instances.
            parent: HoeffdingTTree.Node or None
                Parent node.
            parent_branch: Int
                Parent branch index
            ...
            """
            return HoeffdingTTree.FoundNode(self, parent, parent_branch)
        ...
        def filter_instance_to_leaf(self, X, parent, parent_branch):
            ...
            if child_index >= 0:
                ...
                if child is not None:
                    ...
                    return HoeffdingTTree.FoundNode(None, self, child_index)
            else:
                return HoeffdingTTree.FoundNode(self, parent, parent_branch)
    ...
    def __init__(self,
        ...
        """ HoeffdingTTree class constructor."""
        super().__init__()
